...
[![My Skills](https://skillicons.dev/icons?i=arch,debian,latex,md,obsidian,matlab,octave,py,anaconda,bash,blender,docker,mongodb,mysql,postgres,sequelize,prisma,redis,ts,js,nodejs,express,nestjs,firebase,git,github&perline=3)](https://skillicons.dev)
